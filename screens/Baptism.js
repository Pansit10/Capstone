      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.requirementsList}>
            ...
            <Text style={styles.requirementItem}>
              • Candle (<Text style={styles.lighterText}>provided by parents</Text>)
            </Text>
            <Text style={styles.requirementItem}>
              • Baptismal cloth (<Text style={styles.lighterText}>provided by church</Text>)
            </Text>
            <Text style={styles.requirementItem}>
              • Video of tree planting (<Text style={styles.lighterText}>required by church</Text>)
            </Text>
            <Text style={styles.requirementItem}>
              • Ninong/Ninang confirmation
            </Text>
            <Text style={styles.requirementItem}>
              • Marriage certificate (<Text style={styles.lighterText}>if married</Text>)
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  lighterText: {
    color: '#999', // Lighter color for the text inside parentheses
  },
  appointmentButton: {
