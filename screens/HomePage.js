  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Image source={require('../assets/image1.png')} style={styles.bannerImage} />
        ...
        <View style={styles.servicesContainer}>
          {services.map((service, index) => (
            ...
            >
              <Ionicons name={service.icon} size={32} color="#333333" />
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.churchInfo}>
            <Text style={styles.boldText}>
              Blessed Virgin Mary, Queen of The World Parish
            </Text>
            {'\n'}
            Established in 1971, the parish was carved from the parish of St. John the Baptist. 
            The pioneering parish priest was Fr. Armando Perez, who built the church and rectory.
          </Text>
        </View>
      </ScrollView>
...
const services = [
  ...
  { title: 'Request Certificate', description: 'Get certificates.', icon: 'document-text-outline', screen: 'RequestCertificate' },
  { title: 'Prayer Intention', description: 'Let us pray.', icon: 'heart-outline', screen: 'Prayer Intention' },
  { title: 'Donate to Church', description: 'Support us.', icon: 'cash-outline', screen: 'Church Donation' },
];
