...
const SpecialMassForm = ({ route, navigation }) => {
  ...
  const handleSubmit = () => {
    if (!massType || !fullName || !contactNumber) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.section}>
          <Text style={styles.label}>Type of Mass (e.g., Death Anniversary)</Text>
          <TextInput 
            style={styles.input} 
            placeholder="Enter type of mass" 
            value={massType} 
